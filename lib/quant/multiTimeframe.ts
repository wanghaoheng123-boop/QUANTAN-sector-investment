...
export function multiTimeframeSignal(
  ...
  // Weekly: classifyTimeframe requires ≥35 bars (MACD signal-line bottleneck).
  // 35 weeks × 5 trading days = 175 daily bars minimum; 200 leaves slack for
  // partial weeks at the edges and missing-bar gaps from holidays.
